...
| 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
| --- | --- | --- | --- | --- | --- | --- | --- | 
| [操作系统](#操作系统) | [计算机网络](#计算机网络) | [编程语言](#编程语言) | [大数据](#大数据) | [微服务](#微服务) | [最新趋势](#最新趋势) | [工具](#工具) | [感悟](#感悟) |
...
- [Ubuntu安装参数](/操作系统/Linux/Ubuntu/Ubuntu安装参数.md)
...
- [Kerberos](/计算机网络/Kerberos.md)
- [RPC](/计算机网络/RPC.md)

## gRPC
- [gRPC入门](/计算机网络/gRPC入门.md)
...
## Java
### 核心技术
- [开篇](/编程语言/Java/Java核心技术/00-开篇.md)
- [Java平台的理解](/编程语言/Java/Java核心技术/01-Java平台的理解.md)
- [Exception和Error的区别](/编程语言/Java/Java核心技术/02-Exception和Error的区别.md)
- [final、finally、finalize](/编程语言/Java/Java核心技术/03-final、finally、finalize.md)
- [强引用、软引用、弱引用、幻象引用](/编程语言/Java/Java核心技术/04-强引用、软引用、弱引用、幻象引用.md)
- [String、StringBuffer、StringBuilder](/编程语言/Java/Java核心技术/05-String、StringBuffer、StringBuilder.md)
- [反射机制&动态代理](/编程语言/Java/Java核心技术/06-反射机制&动态代理.md)

### 笔记
- [IO](/编程语言/Java/Java笔记/IO.md)
- [Jackson教程](/编程语言/Java/Java笔记/Jackson教程.md)
- [Jackson解析json](/编程语言/Java/Java笔记/Jackson解析json.md)
- [Java笔记](/编程语言/Java/Java笔记/Java笔记.md)
- [JSON语法](/编程语言/Java/Java笔记/JSON语法.md)
- [Log4J](/编程语言/Java/Java笔记/Log4J.md)
- [常用类库](/编程语言/Java/Java笔记/常用类库.md)
- [流与文件](/编程语言/Java/Java笔记/流与文件.md)

## JVM
### 深入拆解JVM
- [Java虚拟机](/编程语言/Java/深入拆解JVM/00-Java虚拟机.md)
- [Java代码是如何运行的](/编程语言/Java/深入拆解JVM/01-Java代码是如何运行的.md)
- [Java基本类型](/编程语言/Java/深入拆解JVM/02-Java基本类型.md)
- [虚拟机如何加载Java类](/编程语言/Java/深入拆解JVM/03-虚拟机如何加载Java类.md)
- [JVM如何执行方法调用](/编程语言/Java/深入拆解JVM/04-JVM如何执行方法调用.md)
...
## Elastic Search
- [fscrawler使用指南](/大数据/Elastic-Search/插件fscrawler使用指南.md)

## Kafka
- [Kafka Consumer](/大数据/Kafka/Kafka-Consumer.md)
- [Kafka Manager](/大数据/Kafka/Kafka-Manager.md)
- [Kafka Tool](/大数据/Kafka/Kafka-Tool.md)
- [Kafka不只是消息系统](/大数据/Kafka/Kafka不只是消息系统.md)
- [Kafka 常用命令](/大数据/Kafka/Kafka常用命令.md)
- [Kafka 核心原理](/大数据/Kafka/Kafka核心原理.md)
- [Kafka 简介](/大数据/Kafka/Kafka简介.md)
- [Kafka 配置文件](/大数据/Kafka/Kafka配置文件.md)
- [Java编写Kafka](/大数据/Kafka/使用Java编写Kafka.md)
- [安全模式下的Kafka](/大数据/Kafka/安全模式下的Kafka.md)
...
- [Spark SQL](/大数据/Spark/Spark-SQL.md)
- [Spark Streaming 消费Kafka数据](/大数据/Spark/Spark-Streaming消费Kafka数据.md)

## Zookeeper
- [PAXOS](/大数据/Zookeeper/PAXOS.md)
- [Zookeeper API](/大数据/Zookeeper/Zookeeper-API.md)
- [Zookeeper入门](/大数据/Zookeeper/Zookeeper入门.md)

## 分布式原理
- [CAP](/大数据/分布式原理/CAP.md)
- [分布式事务](/大数据/分布式原理/分布式事务.md)
- [分布式存储](/大数据/分布式原理/分布式存储.md)
- [分布式架构](/大数据/分布式原理/分布式架构.md)
- [分布式系统](/大数据/分布式原理/分布式系统.md)
- [分布式锁](/大数据/分布式原理/分布式锁.md)
- [负载均衡](/大数据/分布式原理/负载均衡.md)

## 消息队列
- [消息中间件](/大数据/消息队列/消息中间件.md)
- [消息系统](/大数据/消息队列/消息系统.md)
- [消息队列对比](/大数据/消息队列/消息队列对比.md)
- [消息队列技术对比](/大数据/消息队列/消息队列技术对比.md)
...
- [kubernetes概念和术语](/微服务/Kubernetes/Kubernetes权威指南/01.2-Kubernetes概念和术语.md)

### Kubernetes深入剖析
- [开篇](/微服务/Kubernetes/Kubernetes深入剖析/00-开篇.md)
- [隔离与限制](/微服务/Kubernetes/Kubernetes深入剖析/01-隔离与限制.md)
- [容器与镜像](/微服务/Kubernetes/Kubernetes深入剖析/02-容器与镜像.md)
- [Docker容器本质](/微服务/Kubernetes/Kubernetes深入剖析/03-Docker容器本质.md)
- [Kubernetes本质](/微服务/Kubernetes/Kubernetes深入剖析/04-Kubernetes本质.md)
- [kubeadm部署集群](/微服务/Kubernetes/Kubernetes深入剖析/05-kubeadm部署集群.md)
- [容器化应用](/微服务/Kubernetes/Kubernetes深入剖析/06-容器化应用.md)
- [核心概念 Pod （1）](/微服务/Kubernetes/Kubernetes深入剖析/07-核心概念-Pod-1.md)
- [核心概念 Pod （2）](/微服务/Kubernetes/Kubernetes深入剖析/07-核心概念-Pod-2.md)
...
- [核心概念 StatefulSet （存储状态）](/微服务/Kubernetes/Kubernetes深入剖析/10-核心概念-StatefulSet-2-存储状态.md)
- [核心概念 StatefulSet （实践）](/微服务/Kubernetes/Kubernetes深入剖析/10-核心概念-StatefulSet-3-实践.md)

### Kubernetes笔记
- [kubernetes排查工具](/微服务/Kubernetes/Kubernetes笔记/01-k8s排错工具.md)
- [kubernetes Pod 异常](/微服务/Kubernetes/Kubernetes笔记/02-k8s的pod异常.md)
- [kubernetes 部署失败的原因](/微服务/Kubernetes/Kubernetes笔记/03-k8s不是失败的十大原因.md)
- [Centos 安装 Kubernetes](/微服务/Kubernetes/Kubernetes笔记/Centos安装K8S.md)
- [Helm](/微服务/Kubernetes/Kubernetes笔记/Helm.md)
- [kubernetes简介](/微服务/Kubernetes/Kubernetes笔记/k8s简介.md)
- [kubectl命令](/微服务/Kubernetes/Kubernetes笔记/kubectl命令.md)
- [kubernetes笔记](/微服务/Kubernetes/Kubernetes笔记/Kubernetes笔记.md)

### 服务网格
- [Istio](/微服务/服务网格/Istio.md)
...
- [ShadowSocks](/工具/ShadowSocks.md)
- [人生工具](/工具/人生工具.md)
- [快速数据开源项目](/工具/快速数据开源项目.md)
- [开发路线图](/工具/开发路线图.md)
- [搭建个人博客](/工具/搭建个人博客.md)
- [语义化版本](/工具/语义化版本.md)
